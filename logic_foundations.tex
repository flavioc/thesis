...
be reused as many times as we wish because it is true indefinetly. This is
...
Naturally, linear logic is well suited for modelling computing systems that deal
