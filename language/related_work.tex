...
represented in a work-list, while operators can be implemented on top of
iterators of the work-list. Galois supports speculative execution by allowing
...
details such as CAS instructions, work-lists, and scheduling order. LM programs
