...
later. The \code{replace} linear predicate represents an update operation
...
\begin{figure}[h]
        ...
        \begin{subfigure}[b]{0.5\textwidth}
                ...
                \caption{After applying rule 3 at node \code{@3}. Replace fact
                   sent to node \code{@5}.}
...
\code{replace/3} facts on different nodes, we can perform multiple value updates
