...
and are explained in more detail in Section~\ref{section:language:expressions}.
...
PageRank program to be presented in Section~\ref{section:language:pagerank}:
...
two restrictions, allows computation to be performed using only the facts
belonging to the same node without requiring communication between multiple
nodes.
