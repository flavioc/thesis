...
next(P))} in neighbor nodes to color them with the other color. Line 
...
immediately sort it, otherwise the rule in line 17 is applied.  \texttt{split}
first splits the list using the pivot \texttt{Pivot} using rules in lines 23-26.
