...
\begin{itemize}
   ...
   \item Rule 3: \code{pagerank/2} re-derived.
...
Given at least 1 \code{update/1} fact, rule 7 will run.
\end{lemma}
\begin{proof}
...
\code{sum-ranks/2} will necessarily fire rule 6,
...
is at least one \code{update/1} fact that
