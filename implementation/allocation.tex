...
a \code{next} pointer that points to a position in the latest page where
objects have not been allocated yet. The third and final element of the memory
pool is the \code{free array}, which is an
...
\code{next} pointer reaches the end of the latest page, a larger page is
allocated and \code{next} is reset to the first position of the new page. The
