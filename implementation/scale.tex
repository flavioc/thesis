...
run time of each program when executed with one thread. The experimental results
show that, on average, our benchmarks have a 15-fold speedup when using 32
threads.
