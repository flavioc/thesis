...
matched until the implicit constraint is true. First, the \code{visit} linked
...
If the implicit constraint had failed, another \code{colored} fact would have been
used by assigning \code{colored} to \code{colored.next()}.  Likewise, if the initial
