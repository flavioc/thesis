...
predicate, \code{edge}, is a persistent predicate that describes the
...
\code{@1} to all other nodes in the graph. Every node has a \code{shortest} fact
that is improved with new \code{relax} facts.
