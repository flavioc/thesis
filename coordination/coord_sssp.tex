...
also propagated to neighbor nodes, which may not be optimal. However, this
shows the beauty of our coordination model since a solution could potentially be implemented by adding new coordination facts
and then changing the underlying machinery to support the new model, without making changes to the semantics of the language.
