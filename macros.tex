...
\newcommand{\mycap}[1]{\caption{\sl{#1}}}

\DefineVerbatimEnvironment{Code}{Verbatim}{xleftmargin=1cm, fontsize=\codesize}
\DefineVerbatimEnvironment{LineCode}{Verbatim}{xleftmargin=1cm, numbers=left,
fontsize=\codesize}
