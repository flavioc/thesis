...
There are many other programming systems for data-centric parallel computation
which are not covered in this chapter. However, we describe some graph-centric 
systems in Section~\ref{section:language:related}.
