...
Fig.~\ref{code:language:btree_replace}). Rules without an RHS are also allowed.
...
program shown in Fig.~\ref{code:language:visit}:
...
program (Fig.~\ref{code:language:visit}
