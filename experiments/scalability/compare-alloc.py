...
if len(sys.argv) != 6:
   print "usage: compare-alloc.py <regular allocator> <other allocator> <prefix> <name reg> <name other>"
   sys.exit(1)
...
for name in regular_threaded.experiment_names():
   ...
   for dataset in datasets:
      ...
      if regular_exp and other_exp:
         regular_exp.allocator_compare(other_exp, sys.argv[3] + "-allocator-", sys.argv[4], sys.argv[5])
